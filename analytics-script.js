...
// 主控制表格 ID: 1zC6SUhBICixxFi1IWqAqkupDQE6WuT-QKBm6TwVwxBQ
...
// - 表格命名：adx-good2-2025-01-15
// - 文件夹：所有每日表格存放在"网站统计数据"文件夹中

// ==================== 配置常量 ====================

const MAIN_SPREADSHEET_ID = '1kdOYaKBOfjJSWKiaVOGa2yTECHhQY7PVq8xhwD5ISm0';
const DATA_FOLDER_NAME = '网站统计数据';
const SPREADSHEET_PREFIX = 'adx-good3-';
